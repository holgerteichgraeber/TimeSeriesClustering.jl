...
cep_input_data_GER=load_cep_data("GER_1")
 ...
 # run clustering
ts_clust_res = run_clust(ts_input_data;method="kmeans",representation="centroid",n_init=100,n_clust=10) # default k-means

 # optimization
opt_res, cep_info = run_cep_opt(ts_clust_res.best_results,cep_input_data_GER;solver=GurobiSolver(),co2limit=750.0)
