...
sup_kw_args["method+representation"]=["kmeans+centroid","kmedoids+medoid","kmedoids_exact+medoid"]#["kmeans+centroid","kmeans+medoid","kmedoids+medoid","kmedoids_exact+medoid","hierarchical+centroid","hierarchical+medoid","dbaclust+centroid","kshape+centroid"]
